...
__constant__ unsigned char all_pairs[][3] = {{0, 1, 1}, {0, 1, 1}, {1, 2, 1}, {2, 0, 1}, {1, 3, 1}, {3, 2, 1}, {2, 0, 1}, {0, 1, 1}, {1, 2, 2}, {3, 0, 2}, {0, 1, 1}, {1, 2, 1}, {2, 3, 1}, {3, 4, 1}, {4, 0, 1}, {0, 2, 2}, {1, 3, 2}, {2, 4, 2}, {3, 0, 2}, {4, 1, 2}, {0, 1, 1}, {1, 2, 1}, {2, 3, 1}, {3, 4, 1}, {4, 5, 1}, {5, 0, 1}, {0, 2, 2}, {1, 3, 2}, {2, 4, 2}, {3, 5, 2}, {4, 0, 2}, {5, 1, 2}, {0, 3, 3}, {1, 4, 3}, {2, 5, 3}, {0, 1, 1}, {1, 2, 1}, {2, 3, 1}, {3, 4, 1}, {4, 5, 1}, {5, 6, 1}, {6, 0, 1}, {0, 2, 2}, {1, 3, 2}, {2, 4, 2}, {3, 5, 2}, {4, 6, 2}, {5, 0, 2}, {6, 1, 2}, {0, 3, 3}, {1, 4, 3}, {2, 5, 3}, {3, 6, 3}, {4, 0, 3}, {5, 1, 3}, {6, 2, 3}, {0, 1, 1}, {1, 2, 1}, {2, 3, 1}, {3, 4, 1}, {4, 5, 1}, {5, 6, 1}, {6, 7, 1}, {7, 0, 1}, {0, 2, 2}, {1, 3, 2}, {2, 4, 2}, {3, 5, 2}, {4, 6, 2}, {5, 7, 2}, {6, 0, 2}, {7, 1, 2}, {0, 3, 3}, {1, 4, 3}, {2, 5, 3}, {3, 6, 3}, {4, 7, 3}, {5, 0, 3}, {6, 1, 3}, {7, 2, 3}, {0, 4, 4}, {1, 5, 4}, {2, 6, 4}, {3, 7, 4}, {0, 1, 1}, {1, 2, 1}, {2, 3, 1}, {3, 4, 1}, {4, 5, 1}, {5, 6, 1}, {6, 7, 1}, {7, 8, 1}, {8, 0, 1}, {0, 2, 2}, {1, 3, 2}, {2, 4, 2}, {3, 5, 2}, {4, 6, 2}, {5, 7, 2}, {6, 8, 2}, {7, 0, 2}, {8, 1, 2}, {0, 3, 3}, {1, 4, 3}, {2, 5, 3}, {3, 6, 3}, {4, 7, 3}, {5, 8, 3}, {6, 0, 3}, {7, 1, 3}, {8, 2, 3}, {0, 4, 4}, {1, 5, 4}, {2, 6, 4}, {3, 7, 4}, {4, 8, 4}, {5, 0, 4}, {6, 1, 4}, {7, 2, 4}, {8, 3, 4}, {0, 1, 1}, {1, 2, 1}, {2, 3, 1}, {3, 4, 1}, {4, 5, 1}, {5, 6, 1}, {6, 7, 1}, {7, 8, 1}, {8, 9, 1}, {9, 0, 1}, {0, 2, 2}, {1, 3, 2}, {2, 4, 2}, {3, 5, 2}, {4, 6, 2}, {5, 7, 2}, {6, 8, 2}, {7, 9, 2}, {8, 0, 2}, {9, 1, 2}, {0, 3, 3}, {1, 4, 3}, {2, 5, 3}, {3, 6, 3}, {4, 7, 3}, {5, 8, 3}, {6, 9, 3}, {7, 0, 3}, {8, 1, 3}, {9, 2, 3}, {0, 4, 4}, {1, 5, 4}, {2, 6, 4}, {3, 7, 4}, {4, 8, 4}, {5, 9, 4}, {6, 0, 4}, {7, 1, 4}, {8, 2, 4}, {9, 3, 4}, {0, 5, 5}, {1, 6, 5}, {2, 7, 5}, {3, 8, 5}, {4, 9, 5}, {0, 1, 1}, {1, 2, 1}, {2, 3, 1}, {3, 4, 1}, {4, 5, 1}, {5, 6, 1}, {6, 7, 1}, {7, 8, 1}, {8, 9, 1}, {9, 10, 1}, {10, 0, 1}, {0, 2, 2}, {1, 3, 2}, {2, 4, 2}, {3, 5, 2}, {4, 6, 2}, {5, 7, 2}, {6, 8, 2}, {7, 9, 2}, {8, 10, 2}, {9, 0, 2}, {10, 1, 2}, {0, 3, 3}, {1, 4, 3}, {2, 5, 3}, {3, 6, 3}, {4, 7, 3}, {5, 8, 3}, {6, 9, 3}, {7, 10, 3}, {8, 0, 3}, {9, 1, 3}, {10, 2, 3}, {0, 4, 4}, {1, 5, 4}, {2, 6, 4}, {3, 7, 4}, {4, 8, 4}, {5, 9, 4}, {6, 10, 4}, {7, 0, 4}, {8, 1, 4}, {9, 2, 4}, {10, 3, 4}, {0, 5, 5}, {1, 6, 5}, {2, 7, 5}, {3, 8, 5}, {4, 9, 5}, {5, 10, 5}, {6, 0, 5}, {7, 1, 5}, {8, 2, 5}, {9, 3, 5}, {10, 4, 5}, {0, 1, 1}, {1, 2, 1}, {2, 3, 1}, {3, 4, 1}, {4, 5, 1}, {5, 6, 1}, {6, 7, 1}, {7, 8, 1}, {8, 9, 1}, {9, 10, 1}, {10, 11, 1}, {11, 0, 1}, {0, 2, 2}, {1, 3, 2}, {2, 4, 2}, {3, 5, 2}, {4, 6, 2}, {5, 7, 2}, {6, 8, 2}, {7, 9, 2}, {8, 10, 2}, {9, 11, 2}, {10, 0, 2}, {11, 1, 2}, {0, 3, 3}, {1, 4, 3}, {2, 5, 3}, {3, 6, 3}, {4, 7, 3}, {5, 8, 3}, {6, 9, 3}, {7, 10, 3}, {8, 11, 3}, {9, 0, 3}, {10, 1, 3}, {11, 2, 3}, {0, 4, 4}, {1, 5, 4}, {2, 6, 4}, {3, 7, 4}, {4, 8, 4}, {5, 9, 4}, {6, 10, 4}, {7, 11, 4}, {8, 0, 4}, {9, 1, 4}, {10, 2, 4}, {11, 3, 4}, {0, 5, 5}, {1, 6, 5}, {2, 7, 5}, {3, 8, 5}, {4, 9, 5}, {5, 10, 5}, {6, 11, 5}, {7, 0, 5}, {8, 1, 5}, {9, 2, 5}, {10, 3, 5}, {11, 4, 5}, {0, 6, 6}, {1, 7, 6}, {2, 8, 6}, {3, 9, 6}, {4, 10, 6}, {5, 11, 6}, {0, 1, 1}, {1, 2, 1}, {2, 3, 1}, {3, 4, 1}, {4, 5, 1}, {5, 6, 1}, {6, 7, 1}, {7, 8, 1}, {8, 9, 1}, {9, 10, 1}, {10, 11, 1}, {11, 12, 1}, {12, 0, 1}, {0, 2, 2}, {1, 3, 2}, {2, 4, 2}, {3, 5, 2}, {4, 6, 2}, {5, 7, 2}, {6, 8, 2}, {7, 9, 2}, {8, 10, 2}, {9, 11, 2}, {10, 12, 2}, {11, 0, 2}, {12, 1, 2}, {0, 3, 3}, {1, 4, 3}, {2, 5, 3}, {3, 6, 3}, {4, 7, 3}, {5, 8, 3}, {6, 9, 3}, {7, 10, 3}, {8, 11, 3}, {9, 12, 3}, {10, 0, 3}, {11, 1, 3}, {12, 2, 3}, {0, 4, 4}, {1, 5, 4}, {2, 6, 4}, {3, 7, 4}, {4, 8, 4}, {5, 9, 4}, {6, 10, 4}, {7, 11, 4}, {8, 12, 4}, {9, 0, 4}, {10, 1, 4}, {11, 2, 4}, {12, 3, 4}, {0, 5, 5}, {1, 6, 5}, {2, 7, 5}, {3, 8, 5}, {4, 9, 5}, {5, 10, 5}, {6, 11, 5}, {7, 12, 5}, {8, 0, 5}, {9, 1, 5}, {10, 2, 5}, {11, 3, 5}, {12, 4, 5}, {0, 6, 6}, {1, 7, 6}, {2, 8, 6}, {3, 9, 6}, {4, 10, 6}, {5, 11, 6}, {6, 12, 6}, {7, 0, 6}, {8, 1, 6}, {9, 2, 6}, {10, 3, 6}, {11, 4, 6}, {12, 5, 6}, {0, 1, 1}, {1, 2, 1}, {2, 3, 1}, {3, 4, 1}, {4, 5, 1}, {5, 6, 1}, {6, 7, 1}, {7, 8, 1}, {8, 9, 1}, {9, 10, 1}, {10, 11, 1}, {11, 12, 1}, {12, 13, 1}, {13, 0, 1}, {0, 2, 2}, {1, 3, 2}, {2, 4, 2}, {3, 5, 2}, {4, 6, 2}, {5, 7, 2}, {6, 8, 2}, {7, 9, 2}, {8, 10, 2}, {9, 11, 2}, {10, 12, 2}, {11, 13, 2}, {12, 0, 2}, {13, 1, 2}, {0, 3, 3}, {1, 4, 3}, {2, 5, 3}, {3, 6, 3}, {4, 7, 3}, {5, 8, 3}, {6, 9, 3}, {7, 10, 3}, {8, 11, 3}, {9, 12, 3}, {10, 13, 3}, {11, 0, 3}, {12, 1, 3}, {13, 2, 3}, {0, 4, 4}, {1, 5, 4}, {2, 6, 4}, {3, 7, 4}, {4, 8, 4}, {5, 9, 4}, {6, 10, 4}, {7, 11, 4}, {8, 12, 4}, {9, 13, 4}, {10, 0, 4}, {11, 1, 4}, {12, 2, 4}, {13, 3, 4}, {0, 5, 5}, {1, 6, 5}, {2, 7, 5}, {3, 8, 5}, {4, 9, 5}, {5, 10, 5}, {6, 11, 5}, {7, 12, 5}, {8, 13, 5}, {9, 0, 5}, {10, 1, 5}, {11, 2, 5}, {12, 3, 5}, {13, 4, 5}, {0, 6, 6}, {1, 7, 6}, {2, 8, 6}, {3, 9, 6}, {4, 10, 6}, {5, 11, 6}, {6, 12, 6}, {7, 13, 6}, {8, 0, 6}, {9, 1, 6}, {10, 2, 6}, {11, 3, 6}, {12, 4, 6}, {13, 5, 6}, {0, 7, 7}, {1, 8, 7}, {2, 9, 7}, {3, 10, 7}, {4, 11, 7}, {5, 12, 7}, {6, 13, 7}, {0, 1, 1}, {1, 2, 1}, {2, 3, 1}, {3, 4, 1}, {4, 5, 1}, {5, 6, 1}, {6, 7, 1}, {7, 8, 1}, {8, 9, 1}, {9, 10, 1}, {10, 11, 1}, {11, 12, 1}, {12, 13, 1}, {13, 14, 1}, {14, 0, 1}, {0, 2, 2}, {1, 3, 2}, {2, 4, 2}, {3, 5, 2}, {4, 6, 2}, {5, 7, 2}, {6, 8, 2}, {7, 9, 2}, {8, 10, 2}, {9, 11, 2}, {10, 12, 2}, {11, 13, 2}, {12, 14, 2}, {13, 0, 2}, {14, 1, 2}, {0, 3, 3}, {1, 4, 3}, {2, 5, 3}, {3, 6, 3}, {4, 7, 3}, {5, 8, 3}, {6, 9, 3}, {7, 10, 3}, {8, 11, 3}, {9, 12, 3}, {10, 13, 3}, {11, 14, 3}, {12, 0, 3}, {13, 1, 3}, {14, 2, 3}, {0, 4, 4}, {1, 5, 4}, {2, 6, 4}, {3, 7, 4}, {4, 8, 4}, {5, 9, 4}, {6, 10, 4}, {7, 11, 4}, {8, 12, 4}, {9, 13, 4}, {10, 14, 4}, {11, 0, 4}, {12, 1, 4}, {13, 2, 4}, {14, 3, 4}, {0, 5, 5}, {1, 6, 5}, {2, 7, 5}, {3, 8, 5}, {4, 9, 5}, {5, 10, 5}, {6, 11, 5}, {7, 12, 5}, {8, 13, 5}, {9, 14, 5}, {10, 0, 5}, {11, 1, 5}, {12, 2, 5}, {13, 3, 5}, {14, 4, 5}, {0, 6, 6}, {1, 7, 6}, {2, 8, 6}, {3, 9, 6}, {4, 10, 6}, {5, 11, 6}, {6, 12, 6}, {7, 13, 6}, {8, 14, 6}, {9, 0, 6}, {10, 1, 6}, {11, 2, 6}, {12, 3, 6}, {13, 4, 6}, {14, 5, 6}, {0, 7, 7}, {1, 8, 7}, {2, 9, 7}, {3, 10, 7}, {4, 11, 7}, {5, 12, 7}, {6, 13, 7}, {7, 14, 7}, {8, 0, 7}, {9, 1, 7}, {10, 2, 7}, {11, 3, 7}, {12, 4, 7}, {13, 5, 7}, {14, 6, 7}, {0, 1, 1}, {1, 2, 1}, {2, 3, 1}, {3, 4, 1}, {4, 5, 1}, {5, 6, 1}, {6, 7, 1}, {7, 8, 1}, {8, 9, 1}, {9, 10, 1}, {10, 11, 1}, {11, 12, 1}, {12, 13, 1}, {13, 14, 1}, {14, 15, 1}, {15, 0, 1}, {0, 2, 2}, {1, 3, 2}, {2, 4, 2}, {3, 5, 2}, {4, 6, 2}, {5, 7, 2}, {6, 8, 2}, {7, 9, 2}, {8, 10, 2}, {9, 11, 2}, {10, 12, 2}, {11, 13, 2}, {12, 14, 2}, {13, 15, 2}, {14, 0, 2}, {15, 1, 2}, {0, 3, 3}, {1, 4, 3}, {2, 5, 3}, {3, 6, 3}, {4, 7, 3}, {5, 8, 3}, {6, 9, 3}, {7, 10, 3}, {8, 11, 3}, {9, 12, 3}, {10, 13, 3}, {11, 14, 3}, {12, 15, 3}, {13, 0, 3}, {14, 1, 3}, {15, 2, 3}, {0, 4, 4}, {1, 5, 4}, {2, 6, 4}, {3, 7, 4}, {4, 8, 4}, {5, 9, 4}, {6, 10, 4}, {7, 11, 4}, {8, 12, 4}, {9, 13, 4}, {10, 14, 4}, {11, 15, 4}, {12, 0, 4}, {13, 1, 4}, {14, 2, 4}, {15, 3, 4}, {0, 5, 5}, {1, 6, 5}, {2, 7, 5}, {3, 8, 5}, {4, 9, 5}, {5, 10, 5}, {6, 11, 5}, {7, 12, 5}, {8, 13, 5}, {9, 14, 5}, {10, 15, 5}, {11, 0, 5}, {12, 1, 5}, {13, 2, 5}, {14, 3, 5}, {15, 4, 5}, {0, 6, 6}, {1, 7, 6}, {2, 8, 6}, {3, 9, 6}, {4, 10, 6}, {5, 11, 6}, {6, 12, 6}, {7, 13, 6}, {8, 14, 6}, {9, 15, 6}, {10, 0, 6}, {11, 1, 6}, {12, 2, 6}, {13, 3, 6}, {14, 4, 6}, {15, 5, 6}, {0, 7, 7}, {1, 8, 7}, {2, 9, 7}, {3, 10, 7}, {4, 11, 7}, {5, 12, 7}, {6, 13, 7}, {7, 14, 7}, {8, 15, 7}, {9, 0, 7}, {10, 1, 7}, {11, 2, 7}, {12, 3, 7}, {13, 4, 7}, {14, 5, 7}, {15, 6, 7}, {0, 8, 8}, {1, 9, 8}, {2, 10, 8}, {3, 11, 8}, {4, 12, 8}, {5, 13, 8}, {6, 14, 8}, {7, 15, 8}};
    ...
    int *pnum_corr_tiles)   // pointer to the length of correlation tasks array
{
    ...
    if (nb > 0) {
        ...
        for (int b = 0; b < pair_list_len; b++)
            if ((sel_pairs[b >> 5] & (1 << (b & 31))) != 0) {
...
#pragma unroll
    ...
    if (calc_extra) {     // gpu_diff_rgb_combo
        ...
        if ((tile_num == DBG_TILE) && (threadIdx.x == 0) && (threadIdx.y == 0)) {
            ...
            printf("max_diff: ");
            for (int ccam = 0; ccam < num_cams; ccam++) {
                printf("%f, ", max_diff_shared[ccam]);
            }
            printf("\n");
            for (int ccol = 0; ccol < colors; ccol++) {
                printf("color%d:   ", ccol);
                for (int ccam = 0; ccam < num_cams; ccam++) {
                    printf("%f, ", ports_rgb_shared[ccol * num_cams + ccam]);
                }
                printf("\n");
            }
            for (int i = 0; i < TEXTURE_THREADS_PER_TILE; i++) {
                printf("tmp[%d]:   ", i);
                for (int ccam = 0; ccam < num_cams; ccam++) {
                    printf("%f, ", max_diff_tmp[ccam * TEXTURE_THREADS_PER_TILE + i]);
                }
                printf("\n");
            }
            for (int ncol = 0; ncol < colors; ncol++) {
                printf("\n%d:total ", ncol);
                for (int ccam = 0; ccam < num_cams; ccam++) {
                    printf("%f, ", ports_rgb_shared[ncol * num_cams + ccam]);
                }
                printf("\n");
                for (int i = 0; i < TEXTURE_THREADS_PER_TILE; i++) {
                    printf("tmp[%d] ", i);
                    for (int ccam = 0; ccam < num_cams; ccam++) {
                        printf("%f, ", ports_rgb_tmp[(ncol * num_cams + ccam) * TEXTURE_THREADS_PER_TILE + i]);
                    }
                    printf("\n");
                }
            }
...
extern "C" __global__ void accumulate_correlations(
    ...
    int d2 = x + y * tilesX;
    for (int d3 = pairs * d2; d3 < pairs * (d2 + 1); d3++) {
        for (int d4 = 256 * d3; d4 < 256 * (d3 + 1); d4++) fcorr_td_acc[d4] += fcorr_td[d4];
        num_acc[d3]++;
    }
}
